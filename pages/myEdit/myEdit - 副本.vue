<template>
	...
	<view class="content">
		...
		<uni-forms class="mt_50" ref="valiForm" label-width="70px">
			...
			<h4>车主认证</h4>
			<text style="height: 80rpx;line-height: 80rpx;">未审核</text>
			...
			<uni-forms-item label="驾驶证:">
				<view style="display: flex;width: 100%;">
					<button type="primary" size="mini">重新上传</button>
					<view style="display: flex;align-items: center;">
						<icon type="success_no_circle" size="16" color="green"/>
						<text class="upload-text">已上传</text>
					</view>
					<button type="default" size="mini" >查看图片</button>
				</view>
			</uni-forms-item>
			<uni-forms-item label="行驶证:">
				<button type="primary" size="mini" @click="handleUpLoad(driving)">去上传</button>
			</uni-forms-item>
